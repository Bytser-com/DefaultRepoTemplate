# Welcome to Bytser contributing guide <!-- omit in toc -->

Thank you for investing your time in contributing to our project! Any contribution you make will be reflected on [docs.bytser.com](https://docs.bytser.com/en) :sparkles:.

**📖 For comprehensive contribution guidance, please visit our official documentation at [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing). This is our canonical source for all contribution processes and policies.**

Read our [Code of Conduct](./CODE_OF_CONDUCT.md) to keep our community approachable and respectable.

This guide provides repository-specific information to supplement the official contribution documentation. For detailed processes, policies, and best practices, always refer to [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing).
...
**Start here:** Visit [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing) for complete contributor onboarding and guidelines.
...
📚 **Primary resource:** [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing) contains our complete contribution workflow and policies.
...
**For detailed issue guidelines, see [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing).**
...
**Complete change guidelines are available at [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing).**
...
1. Fork the repository (see [official forking guide](https://docs.bytser.com/en/contributing))
2. Install Node.js at the version specified in `.node-version` (see [development guide](../contributing/development.md))
3. Create a working branch and start with your changes

### Commit your update

Follow the guidelines at [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing) for commit best practices. 
...
**Complete pull request (PR) guidelines:** [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing)
...
A Docs team member will review following our [standard review process](https://docs.bytser.com/en/contributing).

### Your PR is merged!

Congratulations :tada::tada: The Bytser team thanks you :sparkles:.

Once merged, your contributions will be visible on [Bytser docs](https://docs.bytser.com/en). 

Continue contributing using our [types of contributions guide](/contributing/types-of-contributions.md) or explore more opportunities at [docs.bytser.com/en/contributing](https://docs.bytser.com/en/contributing).
